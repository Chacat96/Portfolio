...
<body>
    <video class="video" autoplay muted loop> 
        <source src="img/particule-cosmique-24243.mp4" type="video/mp4">
        </video>
        <h1>Politique de confidentialité</h1>
        <p class="confidentialité">
Le site web portfolio est détenu par Charlène Catherin, qui est un contrôleur de données de vos données personnelles.

Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par portfolio, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d'utiliser le site web de portfolio.
...
Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à c.catherin@outlook.fr.
        </p>
