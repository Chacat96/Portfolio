...
?>
  ...
  <div class="slide">
    <figure class="shadow">
      <a href="competence.php"><img src="img/skill.jpg" alt=""></a>
    </figure>
    <p class="legende">Mes compétences</p>
  </div>
  <div class="slide">
    <figure class="shadow">
      <a href="projet.php"><img src="img/laptop-5673901_1920.jpg"></a>
    </figure>
    <p class="legende">Mes projets</p>
  </div>
  <div class="slide">
    <figure class="shadow">
      <a href="contact.php"><img src="img/image formulaire.png" alt=""></a>
    </figure>
    <p class="legende">Contact</p>
  </div>
  <div class="slide">
    <figure class="shadow">
      <a href="cv.php"><img src="img/cv.png" alt=""></a>
    </figure>
    <p class="legende">CV</p>
  </div>
  <div class="slide">
    <figure class="shadow">
      <a href="description.php"><img src="img/moianime.jpg" alt=""></a>
    </figure>
    <p class="legende">Ma description</p>
  </div>
</div>
